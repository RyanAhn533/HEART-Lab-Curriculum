...
## 1. LeNet-5 — LeCun et al., 1998 (W5 — CNN 실습 후)
...
## 2. AlexNet — Krizhevsky et al., 2012 (W5 — CNN 실습 후)
...
## 3. LSTM — Hochreiter & Schmidhuber, 1997 (W5 — RNN/LSTM 실습 후)
...
## 4. Word2Vec — Mikolov et al., 2013 (W5 — 임베딩 예습)
...
## 5. VGGNet — Simonyan & Zisserman, 2014 (3개월차 — 전이학습)
...
## 6. ResNet — He et al., 2015 (3개월차 — 전이학습)
...
## 7. Attention Is All You Need — Vaswani et al., 2017 (W8 지도만 → 3개월차 재현, 필수)
...
- **경로:** 3B1B "Attention in transformers" → codingopera.tistory.com/43 → 원문. 이 논문은 3개월차 PyTorch 재현 프로젝트의 목표물이다. W8에는 위치만 확인한다.
...
| # | 논문 | 연도 | 부순 문제 | 시점 |
|---|------|------|----------|------|
| 1 | LeNet-5 | 1998 | 이미지에 MLP는 낭비 | W5 |
| 2 | AlexNet | 2012 | "깊게는 못 만든다" | W5 |
| 3 | LSTM | 1997 | RNN 기울기 소실 | W5 |
| 4 | Word2Vec | 2013 | one-hot엔 의미가 없다 | W5 |
| 5 | VGGNet | 2014 | 필터 설계의 복잡함 | 3개월차 |
| 6 | ResNet | 2015 | 깊이의 최적화 실패 | 3개월차 |
| 7 | Attention | 2017 | RNN의 순차 병목 | W8→3개월차 |
