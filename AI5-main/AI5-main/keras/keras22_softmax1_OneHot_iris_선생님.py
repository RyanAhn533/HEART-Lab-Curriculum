...
y = pd.get_dummies(y)  # 1 0 0   0 1 0  이렇게 바꿔줌
...
x_train, x_test, y_train, y_test = train_test_split(x, y, train_size=0.7, random_state=7777)
...
"""
#sklearn
oneHotEncoder = OneHotEncoder(sparse = Flase)
y = OneHotEncoder.fit_transform(dataset.target.reshape(-1, 1))
