...
model.save_weights("./_save/keras28/keras28_5_save_model.h5")


# model.save("./_save/keras28/keras28_1_save_model.h5")

#model = load_model("c:/프로그램/ai5/_save/keras28/keras28_1_save_model.h5")
...
model.save_weights("./_save/keras28/keras28_5_save_model2.h5")
