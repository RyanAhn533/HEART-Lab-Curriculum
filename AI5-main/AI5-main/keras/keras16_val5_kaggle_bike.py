...
x_train, x_val, y_train, y_val = train_test_split(x, y, shuffle=True, random_state=132, train_size=0.2)
#모델구성
model = Sequential()
...
model.fit(x_train, y_train, epochs=1000, batch_size=762, verbose=1, validation_split=0.2)
...
sampleSubmission_csv.to_csv(path + "submission_0718_2123.csv")
