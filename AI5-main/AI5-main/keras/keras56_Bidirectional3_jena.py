...
from tensorflow.keras.layers import Dense, Conv2D, Flatten, Dropout, Input, BatchNormalization, Bidirectional
...
#2. 모델구성
model = Sequential()
model.add(Bidirectional(LSTM(units=64, input_shape=(144,13), return_sequences=True))) # timesteps , features
...
sample_submission_csv.to_csv(path1 + "jena_안준영.csv")