...
from tensorflow.keras.layers import Dense, Bidirectional, GRU, Conv2D, Flatten, Dropout, LSTM
...
print(x1_train.shape, x2_train.shape,y.shape)
x1_train = x1_train.reshape(886,16,9,1)
x2_train = x2_train.reshape(886,16,9,1)
#(917, 16, 8) (917, 16, 8) (1, 16, 1) (1, 16, 1) (917, 16, 1) (871, 16, 8) (871, 16, 8) (917, 16, 1)

#2-1 모델
input1 = Input(shape=(16,9,1))
dense1 = Conv2D(32, (2,2), activation='relu')(input1)
dense2 = Dense(64, activation='relu')(dense1)
dense3 = Dense(128, activation='relu')(dense2)
flatten1 = Flatten()(dense3)
# flatten1 = flatten1 
dense4 = Dense(64, activation='relu')(flatten1)
dropout4 = Dropout(0.2)(dense4)
output1 = Dense(32, activation='relu')(dropout4)
model1 = Model(inputs=input1, outputs=output1)
model1.summary()

#모델2_2
input11 = Input(shape=(16,9,1))
dense11 = Conv2D(32, (2,2), activation='relu')(input11)
...
dropout3 = Dropout(0.2)(dense15)
output11 = Dense(16, activation='relu')(dropout3)
...
path1 = 'C:\\프로그램\\ai5\\_save\\중간고사 가중치\\'
