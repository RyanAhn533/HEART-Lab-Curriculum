...
re_test_csv = re_test_csv.drop(['CustomerId', 'Surname'], axis=1)

x = re_train_csv.drop(['Exited','CustomerId', 'Surname'], axis=1)
...
sample_submission_csv.to_csv(path + "submission_0722_3.csv")
"""
