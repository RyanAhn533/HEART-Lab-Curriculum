...
# model.summary()
path1 = "C:/ai5/_save/중간고사가중치/keras63_99_성우하이텍_안준영.hdf5"
model = load_model(path1)
# #3. 컴파일, 훈련
# import time
# model.compile(loss='mse', optimizer='adam', metrics = ['mse'])
# start = time.time()
# model.fit([x1_train, x2_train],y_train, epochs=1000, validation_split=0.2, batch_size=128)
...
print("성우하이텍 8월19일 종가: ", y_pred[0:1,0])

#로스는 ? [698853.125, 698853.125]
# 성우하이텍 8월19일 종가:  [7450.8887]