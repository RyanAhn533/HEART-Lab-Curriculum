...
bay.maximize(init_points=2, n_iter=n_iter)
end_time = time.time()
...
'''
{'target': 0.7781097002768385, 'params': {'bagging_temperature': 0.0, 'depth': 10.0, 'l2_leaf_reg': 2.5747532358361203, 'learning_rate': 0.1, 'subsample': 1.0}}
100번 걸린 시간은? 81.59 초
'''