...
x = joblib.load(np_path + 'x_data_14.dat')
y = joblib.load(np_path + 'y_data_14.dat')
test = joblib.load(np_path + 'test_data_14.dat')
...
joblib.dump(model, './_save/dacon02/d02_14.pkl')
...
submisson.to_csv(path + 'baseline_submission_14.csv', encoding='UTF-8-sig', index=False)

print('f1_score :', f1, '/ time :', round(end-start, 2), '초 >')

'''
epo=300 random=123 depth=2 gamma=2 learning_rate=0.12
f1_score : 0.39052612601618086 / time : 994.73 초 > d02_14_0909_1533 > 점수 0.29408
