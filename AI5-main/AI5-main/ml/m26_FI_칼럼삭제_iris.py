...
df = df.drop(['sepal width (cm)'], axis=1)  # 수정된 데이터프레임을 다시 df에 저장

# x, y 설정
x = df.values  # df.data 대신 df.values 사용
y = dataset.target
...
acc 1.0
[0.03333333 0.5607589  0.40590776]
...
acc 1.0
[0.18034422 0.41379125 0.40586453]
'''