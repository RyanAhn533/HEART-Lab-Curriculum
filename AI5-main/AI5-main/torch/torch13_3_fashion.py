...
train_dataset = fashion_mnist(path, train=True, download=True, transform=transform)
test_dataset = fashion_mnist(path, train=False, download=True, transform=transform)
