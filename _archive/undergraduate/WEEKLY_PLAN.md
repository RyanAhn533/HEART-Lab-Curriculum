...
5. **매달 마지막 주에 월간 발표** (전체 랩미팅, 10분)

## 월간 발표 (신입생)

학부/석사 신입생도 매달 랩미팅에서 발표한다.

| 시기 | 발표 내용 | 시간 |
|------|----------|------|
| 1개월차 (W4) | AI 기초 학습 현황 + 손계산 시연 + 코딩 결과 (MNIST 등) | 10분 |
| 2개월차 (W8) | Seq2Seq~Transformer 이해도 + 코딩 결과 (분류, 챗봇) | 10분 |
| 3개월차 (W12) | 최종 발표 (프로젝트 완성물) | 10분 |
